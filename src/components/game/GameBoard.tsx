...
export function GameBoard() {
  ...
  return (
    <div className="w-full max-w-[480px] mx-auto p-1.5 sm:p-3 glass-panel rounded-2xl border border-white/10 shadow-2xl select-none">
      <div className="grid grid-cols-8 gap-0.5 sm:gap-1.5 w-full">
        {board.map((card) => {
